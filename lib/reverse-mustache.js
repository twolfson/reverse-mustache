          ...
          for (; i > 0; i -= 1) {
            ...
            for (; j > 0; j -= 1) {
              ...
              var proposedVal = matchContexts.map(function (matchContext) {
                ...
                // TODO: Map the matches into their respective flavors (e.g. `object`, `.`, `true`)
                return true;
              });
              console.log('wat', proposedVal);
              ...
              if (resultContext) {
                return resultContext;
              // Otherwise, continue
              // TODO: Remove this as it is only here to skip the remainder of this loop
              } else {
                continue;
              }
