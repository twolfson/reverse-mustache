      ...
      case '#': // If/loop
        ...
        if (val !== undefined) {
          ...
          for (; i > 0; i -= 1) {
            ...
            // TODO: If there is one item, try both upcasting as an array and leaving it as an object

            // For each of the items
              // Generate a context to match against (clean because of nested tokens)
              var matchContext = new Context(remainingContent);
              // TODO: Set `.` to be the item (and extend any meta data about it)
          ...
          var proposedContext = dfs(subcontext, subtokens);
          ...
          proposedContext.addStr(proposedContext.completedContent);
