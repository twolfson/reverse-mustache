...
function reverseMustache(params) {
  ...
  function dfs(content, tokens, parentContext) {
    ...
    switch (type) {
      case '#': // If/loop
        // TODO: If we already have the value
        ...
        while (true) {
          ...
          // TODO: Generate a context for the objects while looping with them
          // TODO: How the hell do we deal with double loops because we are pre-maturely truncating the loop when it could be longer. However, the inner nested loop could be even longer.
          // TODO: This can be resolved by not setting the value, then re-running the parser at the maximum match and working backwords =D
